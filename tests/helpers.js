 ...
 * matching the rest of this repo's zero-build-step philosophy.
 */

// A few of this app's modules (settings.js, storage.js) call the browser's
// localStorage API directly. This is a tiny in-memory stand-in so those
// modules can be required and exercised under Node.
...
module.exports = { makeLocalStorage, createRunner };
